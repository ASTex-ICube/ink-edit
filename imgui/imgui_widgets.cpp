...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    if (mixed_value)
    {
        ...
        // This may seem awkwardly designed because the aim is to make ImGuiItemFlags_MixedValue supported by all widgets (! just checkbox)
...
// - For scanning we need to remove all width and precision fields and flags "%+3.7f" -> "%f". BUT don't strip types like "%I64d" which includes digits. not "%07I64d" -> "%I64d"
